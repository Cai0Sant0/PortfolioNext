...
const Skills = () => {
    return (
        <div>
            <h1 className="text-center text-2xl md:text-4xl xl:text-5xl font-bold text-white">Minhas <span className="text-cyan-300">Habilidades</span></h1>
                    ...
                    return (
                            <Tilt key={skill.name} scale={1.5} transitionSpeed={400}>
                                <div className="bg-[#14134145] text-center w-40 h-48 rounded-3xl flex flex-col items-center justify-center shadow-lg transition hover:scale-105">
                                    ...
                                    <p className="text-2xl font-semibold text-gray-300">{skill.percent}%</p>
